...
namespace garazol\yii2AddBodyClass\components\behaviors;
...
class BodyClassBehavior extends Behavior
{
    ...
    /**
     * For auto generate user logged in/out status classes
     */
    const AUTO_GENERATE_USER_LOGGED_STATUS = 'userLoggedStatus';

    /**
     * For auto generate current controller action classes
     */
    const AUTO_GENERATE_CONTROLLER_ACTION = 'controllerAction';

    /**
     * For auto generate current module based class
     */
    const AUTO_GENERATE_MODULE = 'module';

    /**
     * @var array automatically generates these kind of classes
     */
    public $autoGeneratedClassTypes = [
        self::AUTO_GENERATE_USER_LOGGED_STATUS,
        self::AUTO_GENERATE_CONTROLLER_ACTION,
        self::AUTO_GENERATE_MODULE,
    ];
